...
export function Cloud({ className, style }: DecorationProp) {
    return (
        <svg 
        className={`cloud ${className ?? ''}`}
        style={style}
        xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 1280.000000 709.000000" 
        preserveAspectRatio="xMidYMid meet"
        >
            <metadata>
                Created by potrace 1.15, written by Peter Selinger 2001-2017
            </metadata>
            <g transform="translate(0.000000,709.000000) scale(0.100000,-0.100000)" fill="currentColor" stroke="none">
